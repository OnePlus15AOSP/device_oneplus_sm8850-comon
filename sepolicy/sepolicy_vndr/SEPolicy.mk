...
SEPOLICY_PATH:= device/oneplus/sm8850-common/sepolicy/sepolicy_vndr/sm8850
QSSI_SEPOLICY_PATH:= device/oneplus/sm8850-common/sepolicy
BOARD_SYSTEM_EXT_SEPOLICY_PREBUILT_DIRS := device/oneplus/sm8850-common/sepolicy/generic
BOARD_PRODUCT_SEPOLICY_PREBUILT_DIRS := device/oneplus/sm8850-common/sepolicy/generic/product
SYS_ATTR_PROJECT_PATH := $(TOP)/device/oneplus/sm8850-common/sepolicy/generic/public/attribute
