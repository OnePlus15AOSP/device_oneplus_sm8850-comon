    ...
    for line in file:
       ...
       if service_name not in bindings:
         sys.exit("\nerror: Service '{0}' is being added, but we have no fuzzer on file for it. "
                  "Fuzzers are listed at $ANDROID_BUILD_TOP/device/qcom/sepolicy_vndr/vndfuzztest/vendor_service_fuzzer_bindings.go \n\n"
                  "new service in vendor_service_fuzzer_bindings.go \n\n"
                  ...
                  "for new service in $ANDROID_BUILD_TOP/device/qcom/sepolicy_vndr/vndfuzztest/vendor_service_fuzzer_bindings.go \n\n"
